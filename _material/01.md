...
_Tietokantajärjestelmä_ pitää huolta tietokannan sisällöstä ja tarjoaa tietokannan käyttäjälle toiminnot, joiden avulla tietoa pystyy hakemaan ja muuttamaan. Huomaa, että sana _tietokanta_ viittaa usein myös tietokantajärjestelmään.
...
Termi _NoSQL_ viittaa tietokantaan, joka perustuu muuhun kuin relaatiomalliin ja SQL-kieleen. Esimerkiksi MongoDB ja Redis ovat tällaisia tietokantoja. Tällä kurssilla emme kuitenkaan juurikaan käsittele NoSQL-tietokantoja.
...
INSERT INTO Customers (name) VALUES ('Uolevi');
INSERT INTO Customers (name) VALUES ('Maija');
INSERT INTO Customers (name) VALUES ('Aapeli');

CREATE TABLE Purchases (customer_id INTEGER, product_id INTEGER);
INSERT INTO Purchases VALUES (1, 2);
INSERT INTO Purchases VALUES (1, 5);
INSERT INTO Purchases VALUES (2, 1);
INSERT INTO Purchases VALUES (2, 4);
