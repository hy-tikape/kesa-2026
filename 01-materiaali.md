...
Tältä sivustolta löydät kurssin verkkomateriaalin. Voit myös katsoa [kaiken materiaalin](../kaikki) samalla sivulla.

Materiaalin tekijä on Antti Laaksonen. Jos löydät virheen materiaalista, voit lähettää korjauksen myös suoraan [GitHubiin](https://github.com/hy-tikape/kesa-2026).
